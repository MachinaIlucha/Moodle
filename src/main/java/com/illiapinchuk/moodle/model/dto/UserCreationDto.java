...
public class UserCreationDto {
  ...
  @Size(min = ApplicationConstants.Web.DataValidation.MIN_SIZE_OF_LASTNAME,
  ...
  @NotBlank(message = ApplicationConstants.Web.DataValidation.ErrorMessage.EMAIL_BLANK_ERROR_MESSAGE)
  ...
  @NotBlank(message = ApplicationConstants.Web.DataValidation.ErrorMessage.LOGIN_BLANK_ERROR_MESSAGE)
  @Size(min = ApplicationConstants.Web.DataValidation.MIN_SIZE_OF_LOGIN,
  ...
  @NotBlank(message = ApplicationConstants.Web.DataValidation.ErrorMessage.PHONE_BLANK_ERROR_MESSAGE)
  @Pattern(regexp = ApplicationConstants.Validation.PHONE_REGEX,
  ...
  @Size(min = ApplicationConstants.Web.DataValidation.MIN_SIZE_OF_COUNTRY,
  ...
  @Size(min = ApplicationConstants.Web.DataValidation.MIN_SIZE_OF_CITY,
